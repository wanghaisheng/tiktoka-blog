...
<footer class="flex flex-col justify-center items-start max-w-2xl mx-auto w-full mb-8">
	...
	<div class="w-full max-w-2xl grid grid-cols-1 gap-4 pb-16 sm:grid-cols-3">
		...
		<div class="flex flex-col space-y-4">
			<ExternalLink
				href="https://www.youtube.com/channel/UCUVNy51YYIuC0cPMwKJuC0Q/"
				cssClasses="{linkClass}"
				ariaLabel="{'Footer LinkedIn link'}">Youtube</ExternalLink
			>
			<ExternalLink
			...
			>
			<ExternalLink
				href="https://twitter.com/tiktoka"
				cssClasses="{linkClass}"
				ariaLabel="{'Footer Twitter link'}">Twitter</ExternalLink
			>
			<ExternalLink
				href="https://www.instagram.com/tiktoka/"
				cssClasses="{linkClass}"
